...
![Theoretical workflow](resources/image/tbcs_001.png)

Following this initial workflow, the program has been structured as follows:

![Data flow within the tracker stages](resources/image/tbcs_029.png)
...
![Enrollment stage](resources/image/tbcs_003.png)
...
![Diagnostic test stage](resources/image/tbcs_004.png)
...
![Smear microscopy](resources/image/tbcs_005.png)

![Xpert MTB/RIF](resources/image/tbcs_006.png)
...
![Baseline info](resources/image/tbcs_007.png)
...
![Baseline info for 2nd line treatment](resources/image/tbcs_079.png)

![Risk factors and HIV status](resources/image/tbcs_008.png)
...
![Diagnosis of a suspected case](resources/image/tbcs_080.png)

![Diagnosis](resources/image/tbcs_009.png)
...
![Clinical diagnosis](resources/image/tbcs_010.png)
...
![Denotification](resources/image/tbcs_011.png)
...
![TB registration number assignment for clinically and bacteriologically diagnosed cases](resources/image/tbcs_019.png)
...
![Error message for the TB registration number assignment for clinically and bacteriologically diagnosed cases](resources/image/tbcs_020.png)

#### Treatment

![Treatment](resources/image/tbcs_012.png)
...
![Outcome](resources/image/tbcs_014.png)
...
![Example of a constant](resources/image/tbcs_018.png)
...
![Top bar info](resources/image/tbcs_015.png)
...
![Feedback text box](resources/image/tbcs_016.png)
